...
public class URLDrawable extends BitmapDrawable {
	...
	public URLDrawable(Context context) {
		...
		drawable = context.getResources().getDrawable(R.drawable.reload);
	...
	public void draw(Canvas canvas) {
		if (drawable != null) {
			//System.out.println("draw height:"+drawable.getBounds().bottom+", real height:"+drawable.getIntrinsicHeight());
